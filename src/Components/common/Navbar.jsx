...
const Navbar = () => {
  ...
  return (
    <header className='w-[70%] md:w-[44%] fixed top-10 left-1/2 -translate-x-1/2 bg-[linear-gradient(rgb(33,33,33)_0%,rgb(20,20,20)_100%)] rounded-4xl py-4 px-5 border-6 border-[#242424] z-999'>
