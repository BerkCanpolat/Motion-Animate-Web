...
const Featured = ({ imageYParallax }) => {
  ...
  return (
    <section className='h-[350dvh]'>
        ...
        <h1 className='text-gray-300 text-2xl md:text-5xl font-extrabold mt-90 z-50 [writing-mode:vertical-rl] [text-orientation:upright] uppercase tracking-[-0.1rem] md:tracking-[-0.9rem]'>featured projects</h1>
        </div>
        {
